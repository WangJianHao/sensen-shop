...
import com.sensen.sensenshop.component.CancelOrderSender;
import com.sensen.sensenshop.dto.OrderParam;
...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    @Override
    public SenCommonResponse<?> generateOrder(OrderParam orderParam) {
        //todo 执行一系类下单操作，具体参考mall项目
        log.info("process generateOrder");
        //下单完成后开启一个延迟消息，用于当用户没有付款时取消订单（orderId应该在下单后生成）
        sendDelayMessageCancelOrder(11L);
        return SenCommonResponse.success(null, "下单成功");
    }
